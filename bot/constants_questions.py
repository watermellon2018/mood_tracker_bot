...
QUESTION_DEFINITIONS: dict[str, dict] = {
    ...
    "self_esteem_guilt": {
        "question_text": "Сегодня были ли мысли о собственной никчёмности или вине?",
        "options": ["Нет", "Редкие", "Иногда", "Часто", "Постоянно"],
    },
    "appetite": {
        "question_text": "Какой сегодня был аппетит?",
    ...
    "panic_attacks": {
        ...
        "options": ["Нет", "Близко к атаке", "1", "Несколько", "Сильные"],
    },
    "obsessive_thoughts": {
    ...
    "avoidance": {
        "question_text": "Избегали ли сегодня каких-то ситуаций из-за тревоги?",
    ...
    "irritability": {
        "question_text": "Насколько сегодня была раздражительность?",
    ...
    "stress_events": {
        "question_text": "Были ли сегодня стрессовые события?",
